...
{
	MSG msg;
	TCHAR AppName[]=TEXT("Ortho Triangle");
	WNDCLASSEX wndclass;
	HWND hwnd;
	...
	hwnd=CreateWindowEx(WS_EX_APPWINDOW,AppName,TEXT("Triangle Ortho"),WS_OVERLAPPEDWINDOW|WS_CLIPCHILDREN|WS_CLIPSIBLINGS|WS_VISIBLE,0,0,800,600,NULL,NULL,hInstance,NULL);
